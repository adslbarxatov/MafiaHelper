...
> Текущая версия руководства: MafiaHelper v 1.5
...
*Для того чтобы роль сработала, она вызывается в приложении одной из первых (вместе с `вором`)*.
...
*Для того чтобы роль сработала, она вызывается в приложении одной из первых (вместе с `врачом`)*.
