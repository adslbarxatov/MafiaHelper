...
> **ƒ** &nbsp;RD AAOW FDL; 19.11.2023; 16:03
...
> Текущая версия руководства: MafiaHelper v 1.4
...
В игре может участвовать от 5 до 20 человек включительно. Также присутствует ведущий,
...
*Для того чтобы роль сработала, она вызывается в приложении одной из первых (вместе с `вором` и `маньяком`)*.
...
*Для того чтобы роль сработала, она вызывается в приложении одной из первых (вместе с `вором` и `врачом`)*.
...
*Для того чтобы роль сработала, она вызывается в приложении одной из первых (вместе с `маньяком` и `врачом`)*.
